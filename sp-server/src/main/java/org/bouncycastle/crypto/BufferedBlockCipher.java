...
public class BufferedBlockCipher {
	...
	public BufferedBlockCipher(BlockCipher par1BlockCipher) {
		...
		if (this.pgpCFB) {
			...
			this.partialBlockOkay = var3 > 0
					&& (var2.startsWith("CFB", var3) || var2.startsWith("OFB", var3) || var2.startsWith("OpenPGP", var3)
							|| var2.startsWith("SIC", var3) || var2.startsWith("GCTR", var3));
		}
	}
	...
	public int processByte(byte[] par1ArrayOfByte, int par2, int par3, byte[] par4ArrayOfByte, int par5)
