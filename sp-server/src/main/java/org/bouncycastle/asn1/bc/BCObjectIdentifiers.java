...
public interface BCObjectIdentifiers {
	...
	ASN1ObjectIdentifier bc_pbe_sha256_pkcs12_aes128_cbc = new ASN1ObjectIdentifier(
			bc_pbe_sha256_pkcs12.getId() + ".1.2");
	ASN1ObjectIdentifier bc_pbe_sha256_pkcs12_aes192_cbc = new ASN1ObjectIdentifier(
			bc_pbe_sha256_pkcs12.getId() + ".1.22");
	ASN1ObjectIdentifier bc_pbe_sha256_pkcs12_aes256_cbc = new ASN1ObjectIdentifier(
			bc_pbe_sha256_pkcs12.getId() + ".1.42");
}
