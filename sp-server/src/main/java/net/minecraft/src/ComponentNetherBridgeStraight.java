...
public class ComponentNetherBridgeStraight extends ComponentNetherBridgePiece {
	public ComponentNetherBridgeStraight(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox,
			int par4) {
		super(par1);
	 ...
	 */
	public static ComponentNetherBridgeStraight createValidComponent(List par0List, Random par1Random, int par2,
