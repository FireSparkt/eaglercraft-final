...
public class ComponentNetherBridgeCorridor3 extends ComponentNetherBridgePiece {
	public ComponentNetherBridgeCorridor3(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox,
			int par4) {
		super(par1);
	 ...
	 */
	public static ComponentNetherBridgeCorridor3 createValidComponent(List par0List, Random par1Random, int par2,
