...
public class ComponentNetherBridgeCorridor4 extends ComponentNetherBridgePiece {
	public ComponentNetherBridgeCorridor4(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox,
			int par4) {
		super(par1);
	 ...
	 */
	public static ComponentNetherBridgeCorridor4 createValidComponent(List par0List, Random par1Random, int par2,
