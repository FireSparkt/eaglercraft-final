...
public class DemoWorldManager extends ItemInWorldManager {
	...
	public void updateBlockRemoving() {
		...
		if (var1 % 24000L == 500L) {
			if (var3 <= 6L) {
				this.thisPlayerMP
						.sendChatToPlayer(this.thisPlayerMP.translateString("demo.day." + var3, new Object[0]));
			}
		} else if (var3 == 1L) {
			if (var1 == 100L) {
	...
	public boolean activateBlockOrUseItem(EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack,
		...
		if (this.demoTimeExpired) {
			...
			return super.activateBlockOrUseItem(par1EntityPlayer, par2World, par3ItemStack, par4, par5, par6, par7,
					par8, par9, par10);
		}
	}
}
