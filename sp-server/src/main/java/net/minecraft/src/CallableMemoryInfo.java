...
class CallableMemoryInfo implements Callable {
	...
	/**
	 * Returns the memory information as a String. Includes the Free Memory in bytes
	 * and MB, Total Memory in bytes and MB, and Max Memory in Bytes and MB.
	 */
	public String getMemoryInfoAsString() {
		...
		return var6 + " bytes (" + var12 + " MB) / " + var4 + " bytes (" + var10 + " MB) up to " + var2 + " bytes ("
				+ var8 + " MB)";
	}
